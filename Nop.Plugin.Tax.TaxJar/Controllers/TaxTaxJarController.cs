    ...
    public class TaxTaxJarController : BasePluginController
    {
        ...
        public ActionResult Configure()
        {
            var model = new TaxTaxJarModel
            {
                ...
                StateProviceTable = _taxJarSettings.StateProviceTable
            };
        ...
        [HttpPost, ActionName("Configure")]
        [FormValueRequired("stateprovince")]
        public ActionResult SaveFilterStateProvice(TaxTaxJarModel model)
        {
            if (!ModelState.IsValid)
                return Configure();

            _taxJarSettings.StateProviceTable = model.StateProviceTable;
            _settingService.SaveSetting(_taxJarSettings);
